...
UPDATED: Using stylable_container for better border styling
============================================================================
"""
...
class WDTAChartVisualizer:
    ...
    UPDATED: Using stylable_container for border styling
    """

    def __init__(self):
        self.color_palette = self._generate_color_palette()
        self.kpi_configs = self._define_kpi_configs()
        self.silver_light_bg = "rgba(245, 245, 245, 1)"  # Silver light background
        self.container_bg = "rgba(245, 245, 245, 0.8)"  # Container background
        self.border_color = "rgba(100, 100, 100, 1)"  # Dark gray for borders
        self.grid_color = "rgba(200, 200, 200, 0.8)"  # Light gray for grid
    ...
    def _create_sector_chart(
        ...
        """Create chart for a specific sector"""
    ...
    def render_kpi_charts_by_sector(self, df: pl.DataFrame, kpi_name: str):
        ...
        st.markdown(f"### 📊 {config['label']} {tower_display}")
